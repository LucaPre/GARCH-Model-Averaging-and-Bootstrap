...
function [Q, sigma_sq, sumLik, sigma_sq_h1, params] = tGJRLikelihood(theta,y,yboot)
a0=(theta(2));
nu=min(200,(theta(1)));
a=(theta(3));
b=(theta(4));
...
for t=3:T
    u=(y(t-1)-y(t-2));
    sigma_sq(t)=a0+(a+c*(u<0))*u^2+b*sigma_sq(t-1);
...
if a+c<0
   Q=1e+50+randn(1); % Enforce a+c to be larger than 0 to ensure positive variance
end
